...
const ProfilePage = () => {
    ...
    // 👇 Стан для активного елементу перетягування
    ...
    const handleDragEnd = async (event) => {
        ...
        setActiveId(null); // 👇 Скидаємо активний ID
    ...
    if (loading) return <div className="min-h-screen flex items-center justify-center text-muted animate-pulse font-mono uppercase tracking-widest">Summoning Profile...</div>;
    ...
    return (
        <div className="max-w-[1920px] mx-auto pb-20 px-4 md:px-8 font-mono">
                    ...
                    <div className="flex flex-col gap-6 text-center lg:text-left">
                        ...
                        <div className="flex flex-col gap-6 items-center lg:items-start">
                            ...
                            <div className="space-y-2 w-full">
                                <h1 className="text-3xl font-bold text-bone font-gothic tracking-wide break-words leading-tight">
                            ...
                            {profileUser.bio && (
                                <p className="text-bone/80 text-xs leading-relaxed whitespace-pre-wrap font-mono break-words text-center lg:text-left w-full">
                                    {profileUser.bio}
                                </p>
                            )}
                        </div>
                ...
                <div className="lg:col-span-9 space-y-16 animate-in slide-in-from-bottom duration-700 delay-200">
                    ...
                    <div className="space-y-8">
                        ...
                        {collections.length === 0 ? (
                            ...
                            // 👇 DndContext з DragOverlay
                            <DndContext 
                                sensors={sensors} 
                                collisionDetection={closestCenter} 
                                onDragStart={handleDragStart} // Фіксуємо, що тягнемо
                            ...
                            >
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                                        {collections.map(col => (
                                            <SortableItem key={col.id} id={col.id} disabled={!isOwner}>
                                                {/* Якщо це активний елемент (який тягнуть), робимо його прозорим у списку */}
                                ...
                                {/* 👇 DragOverlay: Це те, що "літає" за курсором. Воно не клікабельне для навігації. */}
                                <DragOverlay>
                                    {activeId ? (
