                            ...
                            {allImages.map((img) => {
                                ...
                                return (
                                    <div 
                                        ...
                                        className={`
                                            min-w-12.5 w-12.5 h-10 rounded-sm overflow-hidden border transition-all cursor-pointer relative shrink-0
                    ...
                    {!isInfoOpen && (
                        ...
                        >
                            <div className="flex flex-col">
                                ...
                                <h2 className="text-sm font-bold text-bone font-gothic tracking-wide uppercase truncate max-w-62.5">
                                    {fullArtwork.title}
                                </h2>
                            </div>
                    ...
                    <div className="p-8 border-b border-border shrink-0 bg-void/50 backdrop-blur-md">
                        ...
                        {fullArtwork.author_name && (
                            <p className="text-xs text-muted mt-2 font-mono uppercase tracking-widest flex items-center gap-2">
                                <span className="w-2 h-px bg-blood"></span>
                                {fullArtwork.author_name}
                            </p>
                        )}
                    </div>
                    
                    <div className="p-8 overflow-y-auto custom-scrollbar flex-1 bg-linear-to-b from-void/20 to-deep">
